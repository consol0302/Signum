...
Run `signum audit-manifest MANIFEST` to measure the manifest against this distribution. Extra events are allowed. `other` events do not satisfy a target category.
